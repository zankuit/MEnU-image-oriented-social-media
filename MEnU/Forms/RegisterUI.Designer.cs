namespace MEnU.Forms
{
    partial class RegisterUI
    {
        ...
        private void InitializeComponent()
        {
            ...
            txtDisplaynameSignup = new TextBox();
            pictureBox3 = new PictureBox();
            groupBox1 = new GroupBox();
            txtUsernameSignup = new TextBox();
            pictureBox2 = new PictureBox();
            label1 = new Label();
            btnLoginSignnup = new Button();
            btnSignupSignup = new Button();
            label2 = new Label();
            ...
            panel1.Controls.Add(btnLoginSignnup);
            ...
            groupBox5.Controls.Add(txtConfirmpasswordSignup);
            ...
            groupBox4.Controls.Add(txtPasswordSignup);
            ...
            groupBox3.Controls.Add(txtEmailSignup);
            ...
            groupBox2.Controls.Add(txtDisplaynameSignup);
            ...
            groupBox1.Controls.Add(txtUsernameSignup);
            ...
            // btnLoginSignnup
            // 
            btnLoginSignnup.AutoSize = true;
            btnLoginSignnup.BackColor = Color.Transparent;
            btnLoginSignnup.BackgroundImageLayout = ImageLayout.Zoom;
            btnLoginSignnup.FlatAppearance.BorderSize = 0;
            btnLoginSignnup.FlatAppearance.MouseDownBackColor = Color.FromArgb(0, 94, 128);
            btnLoginSignnup.FlatAppearance.MouseOverBackColor = Color.FromArgb(34, 140, 178);
            ...
            // btnSignupSignup
            // 
            btnSignupSignup.AutoSize = true;
            btnSignupSignup.BackColor = Color.FromArgb(105, 203, 253);
            btnSignupSignup.BackgroundImageLayout = ImageLayout.Zoom;
            btnSignupSignup.FlatAppearance.BorderSize = 0;
            btnSignupSignup.FlatAppearance.MouseDownBackColor = Color.FromArgb(0, 94, 128);
            btnSignupSignup.FlatAppearance.MouseOverBackColor = Color.FromArgb(34, 140, 178);
        ...
        private Button btnLoginSignnup;
